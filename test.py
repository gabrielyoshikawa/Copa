...
elif pontosCamaroes > pontosBrasil and pontosCamaroes > pontosSuica and pontosCamaroes > pontosSuica:
    print('1º Camarões')
    # if pontosBrasil == pontosSuica or pontosBrasil == pontosServia or pontosServia == pontosCamaroes
